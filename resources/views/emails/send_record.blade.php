                                            ...
                                            <table class="body-text">
                                                <tr>
                                                    <td class="body-text-cell">
                                                        You have been sent a record information from {{ config('app.name') }}. <a href="{{ $url }}"><b>Click Here</b></a> to continue.
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="body-text-cell">
                                                        If you cannot see the link, copy this url into your web browser.
                                                        <br>
